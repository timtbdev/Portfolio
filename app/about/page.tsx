      ...
      <div className="mx-auto mb-10 max-w-7xl px-6 sm:mb-14 lg:px-8">
        <div className="mx-auto max-w-2xl px-8 text-center lg:max-w-4xl lg:px-10">
          ...
          <Text className="mb-8 md:mb-6">
            My name is Tim, and I&apos;m an Android and Frontend developer based
          ...
          <Text className="mb-2 md:mb-4">
            ...
            launched 2 mobile and 2 web apps, and open-sourced them on GitHub. I
            enjoy making smooth and fun web and mobile UI&apos;s with modern
          ...
          <Text className="mb-2 md:mb-4">
            Outside of Android, I&apos;m a passionate runner, husband, and dad.
          </Text>
          <Photo
            image={FamilyImage}
