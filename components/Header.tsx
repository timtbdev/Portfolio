...
export default function Header() {
  ...
  return (
    <Disclosure
      as="nav"
      className="top-0 z-40 border-y-[1.5px] border-slate-300 bg-gray-50/30 shadow-sm backdrop-blur-lg transition-colors duration-500 dark:border-slate-600/50 dark:bg-slate-800 dark:shadow-slate-900 sm:sticky"
    >
      {({ open }) => (
        <>
          <nav
